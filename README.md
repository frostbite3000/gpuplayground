...
**Windows 9x DOS box**: Should work but be wary of running tests, especially graphics tests, while the drivers are running. Other's drivers, especially their old ones, are infamously temperamental and may not like being interfered with.
